...
WebUI.click(findTestObject('Object Repository/Page_Cmera IoT/main'))

WebUI.click(findTestObject('Object Repository/Page_Cmera IoT/button_Dicionrio ArUco_startBtn'))

WebUI.click(findTestObject('Object Repository/Page_Cmera IoT/button_Dicionrio ArUco_startBtn'))

WebUI.click(findTestObject('Object Repository/Page_Cmera IoT/a_Cadastrar nova moto_btn secondary'))
